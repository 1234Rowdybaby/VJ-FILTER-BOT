...
PICS = (environ.get('PICS', 'https://graph.org/file/ddd8de39b2c2837a17fbb-71c203d52bb4a6e9d7.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6046055058').split()] # For Multiple Id Use One Space Between Each.
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '6046055058').split()]  # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002409171321').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002145371667') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1002359536802')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002459015261')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

# This Channel Is For /batch command file store.
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002643518836')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Prahud232:Prahud232@cluster0.m7jmt.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://graph.org/file/5635f6bd5f76da19ccc70-695af75bfa01aacbf2.jpg') # payment code picture url.
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/SANDY_BOTS')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+4pPWKtxin2YyNTc1') # Support Chat Link Without https:// or @
